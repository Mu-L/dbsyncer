package org.dbsyncer.connector.mysql.ddl.samedb;
 ...
 */
public class MysqlSameTypeAlterDialect extends AbstractSameTypeAlterDialect {

    private static final String MYSQL = "MySQL";

    @Override
    public boolean supportsConnectorType(String connectorType) {
        return equalsIgnoreCase(connectorType, MYSQL);
    }
